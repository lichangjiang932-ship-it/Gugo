...
| `tailwind.js` | tailwindcss play CDN (latest) | https://cdn.tailwindcss.com | 2026-05-30 |

## 更新方法

```bash
cd public/sandbox
curl -fsSL -o react.umd.js          https://unpkg.com/react@18/umd/react.development.js
curl -fsSL -o react-dom.umd.js      https://unpkg.com/react-dom@18/umd/react-dom.development.js
curl -fsSL -o babel.standalone.js   https://unpkg.com/@babel/standalone/babel.min.js
