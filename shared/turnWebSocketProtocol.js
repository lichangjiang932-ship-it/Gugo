...
export const TURN_WEBSOCKET_SERVER_FRAME_SCHEMA = z.discriminatedUnion('type', [
  ...
  z.object({
    ...
    recovery: jsonRecordSchema.optional(),
    partialText: z.string().optional(),
    artifactIds: z.array(z.string()).max(64).optional(),
    deliveryArtifactIds: z.array(z.string()).max(64).optional(),
    verifiedLocalFiles: z.array(jsonRecordSchema).max(128).optional(),
    retainedLocalFiles: z.array(jsonRecordSchema).max(128).optional(),
