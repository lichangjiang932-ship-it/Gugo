...
test('presentation artifacts open in an immersive fixed-ratio canvas', () => {
  ...
  assert.match(source, /maximized \? 'chat-preview-pane-maximized fixed inset-0 w-screen'/)
  assert.match(source, /focused \? 'chat-preview-pane-focused absolute inset-0 w-full' : 'relative shrink-0'/)
