...
function createInitialState() {
  return {
    ...
    toolsConfig: { web_search: false, fetch_url: false, create_pptx: true, create_docx: true, create_xlsx: true, create_react_component: true, create_mermaid: true, analyze_data: true, read_file: false, write_file: false, edit_file: false, bash_exec: false, git_status: false, git_diff: false, run_project_check: false }, // tool toggles
  ...
  switch (action.type) {
    ...
    case 'APPEND_TO_LAST_MESSAGE': {
      ...
      return {
        ...state,
        sessions: state.sessions.map((s) => {
          if (s.id !== state.activeSessionId || !Array.isArray(s.messages) || s.messages.length === 0) return s
