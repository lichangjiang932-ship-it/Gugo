...
export default function ReasonixWorkspace() {
  ...
  return <div className="min-h-screen bg-paper text-ink">
    <header className="sticky top-0 z-10 border-b border-ink/20 bg-paper/95 backdrop-blur"><div className="mx-auto flex max-w-5xl items-center gap-4 px-6 py-4"><Link to="/chat" className="flex items-center gap-1 text-sm text-ink-soft transition-colors hover:text-ink"><ArrowLeft className="h-4 w-4" />{COPY.back}</Link><div className="h-5 w-px bg-ink-fade/40" /><div className="flex items-center gap-2"><span className="font-mono text-[9px] uppercase tracking-[0.22em] text-ink-fade">REASONIX-INSPIRED</span><h1 className="font-hand text-2xl text-ink">{COPY.title}</h1></div></div>
