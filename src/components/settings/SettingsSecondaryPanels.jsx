...
function Group({ title, children }) {
  return <div className="p-4 border border-ink/30 rounded-md flex flex-col gap-3"><h3 className="font-semibold text-lg text-ink">{title}</h3>{children}</div>
}
