...
export const CLOUD_PRESETS = Object.freeze([
  ...
  { id: 'openrouter', key: 'openrouter', label: 'OpenRouter', baseUrl: 'https://openrouter.ai/api/v1', models: ['openai/gpt-5.6-sol', 'anthropic/claude-opus-4.8', 'google/gemini-3.1-pro'], kind: 'openai-compatible', caps: CAPS.tools },
  ...
  { id: 'xai', key: 'xai', label: 'xAI Grok', baseUrl: 'https://api.x.ai/v1', models: ['grok-4.1', 'grok-4.1-fast', 'grok-4-fast'], kind: 'openai-compatible', caps: CAPS.tools },
