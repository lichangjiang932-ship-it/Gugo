const translations = {
  "zh": {
    ...
    "sessionMenuFor": "会话“{title}”的更多操作",
    "pinnedSession": "已置顶",
    "expandProject": "展开项目“{project}”（{count} 个会话）",
    "collapseProject": "收起项目“{project}”（{count} 个会话）",
    "emptyProject": "此项目还没有会话",
    "groupToday": "今天",
    "groupYesterday": "昨天",
    "groupWeek": "本周",
    "groupEarlier": "更早",
    ...
    "branchNavigator": "会话分支",
    "branchLoading": "正在加载分支…",
    "branchLoadFailed": "无法加载会话分支",
    "branchRoot": "主分支",
    "branchUntitled": "未命名分支",
    "branchCurrent": "当前",
    "branchEmpty": "暂无可用分支",
    "branchFileChanges": "文件变化 {count}",
    "branchFileChangesIncomplete": "（部分）",
    "branchFileChangesUnavailable": "文件变化证据不完整",
    "archiveSession": "归档会话",
  ...
  "en": {
    ...
    "sessionMenuFor": "More actions for “{title}”",
    "pinnedSession": "Pinned",
    "expandProject": "Expand “{project}” ({count} conversations)",
    "collapseProject": "Collapse “{project}” ({count} conversations)",
    "emptyProject": "No conversations in this project yet",
    "groupToday": "Today",
    ...
    "branchNavigator": "Conversation branches",
    "branchLoading": "Loading branches…",
    "branchLoadFailed": "Could not load conversation branches",
    "branchRoot": "Main branch",
    "branchUntitled": "Untitled branch",
    "branchCurrent": "Current",
    "branchEmpty": "No branches are available",
    "branchFileChanges": "{count} file changes",
    "branchFileChangesIncomplete": "(partial)",
    "branchFileChangesUnavailable": "File-change evidence is incomplete",
