...
const FEATURE_PAGE_TRANSLATIONS = {
  zh: {
    chatMessages: {
      ...
      reasoning: '思考过程', reasoningActive: '思考中…', toolCallReady: '正在准备运行 {name}…', characters: '{count} 字', clickExpand: '点击展开', execution: '执行过程', runningSteps: '进行中 · {count} 步', steps: '{count} 步', failedSteps: '{count} 步失败', answerFollows: '↓ 以下是基于上述执行结果给出的答复',
  ...
  en: {
    chatMessages: {
      ...
      reasoning: 'Reasoning', reasoningActive: 'Thinking…', toolCallReady: 'Preparing to run {name}…', characters: '{count} characters', clickExpand: 'Click to expand', execution: 'Execution', runningSteps: 'Running · {count} steps', steps: '{count} steps', failedSteps: '{count} failed', answerFollows: '↓ The answer below is based on the execution results above',
