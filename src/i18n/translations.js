...
Object.assign(FEATURE_PAGE_TRANSLATIONS.zh.chatMessages, {
  ...
  incompleteVerifiedFiles: '{count} 个文件已验证，可正常打开', incompletePendingFiles: '{count} 个文件已保存但仍待验证',
...
Object.assign(FEATURE_PAGE_TRANSLATIONS.en.chatMessages, {
  ...
  incompleteVerifiedFiles: '{count} verified file(s) can be opened', incompletePendingFiles: '{count} saved file(s) still await verification',
