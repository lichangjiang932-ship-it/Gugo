...
export const translations = {
  zh: {
    ...
    modelProviders: {
      ...
      chooseProvider: '选择模型服务', providerQwen: '阿里云通义千问', providerSiliconFlow: '硅基流动', providerZhipu: '智谱 GLM', custom: '自定义接口', advanced: '高级自定义配置', apiKeyRequired: '请填写所选模型服务的 API Key。', apiKeyPlaceholder: '粘贴 API Key，密钥仅保存在本机服务端', localDetectHint: '请先启动本地模型服务，再点击下方“检测模型”；系统会自动填入已安装模型。',
  ...
  ja: {
    ...
    modelProviders: {
      ...
      chooseProvider: 'モデルサービスを選択', providerQwen: 'Alibaba Cloud Qwen', providerSiliconFlow: 'SiliconFlow', providerZhipu: 'Zhipu GLM', custom: 'カスタムエンドポイント', advanced: '詳細なカスタム設定', apiKeyRequired: '選択したモデルサービスの API Key を入力してください。', apiKeyPlaceholder: 'API Key を貼り付け（ローカルサーバーのみに保存）', localDetectHint: 'ローカルモデルサービスを起動し、下の「モデルを検出」を選択してください。',
  ...
  ko: {
    ...
    modelProviders: {
      ...
      chooseProvider: '모델 서비스 선택', providerQwen: 'Alibaba Cloud Qwen', providerSiliconFlow: 'SiliconFlow', providerZhipu: 'Zhipu GLM', custom: '사용자 지정 엔드포인트', advanced: '고급 사용자 지정 설정', apiKeyRequired: '선택한 모델 서비스의 API Key를 입력하세요.', apiKeyPlaceholder: 'API Key 붙여넣기(로컬 서버에만 저장)', localDetectHint: '로컬 모델 서비스를 시작한 뒤 아래의 모델 감지를 선택하세요.',
  ...
  'zh-TW': {
    ...
    modelProviders: {
      ...
      chooseProvider: '選擇模型服務', providerQwen: '阿里雲通義千問', providerSiliconFlow: '矽基流動', providerZhipu: '智譜 GLM', custom: '自訂接口', advanced: '進階自訂設定', apiKeyRequired: '請填寫所選模型服務的 API Key。', apiKeyPlaceholder: '貼上 API Key，密鑰只保存在本機伺服器', localDetectHint: '請先啟動本機模型服務，再點擊下方「偵測模型」。',
