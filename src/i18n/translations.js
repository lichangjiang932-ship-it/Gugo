...
const SETTINGS_MODAL_TRANSLATIONS = {
  zh: {
    ...
    themeDescription: '选择浅色、纯白、深色或跟随系统。', accentColor: '强调色', accentColorDescription: '用于主要操作和状态提示。', setAccentColor: '设置强调色 {color}',
  ...
  en: {
    ...
    themeDescription: 'Choose light, white, dark, or system appearance.', accentColor: 'Accent color', accentColorDescription: 'Used for primary actions and status.', setAccentColor: 'Set accent color {color}',
  ...
  ja: {
    ...
    themeDescription: 'ライト、ホワイト、ダーク、システム連動から選択します。', accentColor: 'アクセント色', accentColorDescription: '主要操作と状態表示に使用します。', setAccentColor: 'アクセント色 {color} を設定',
  ...
  ko: {
    ...
    themeDescription: '라이트, 화이트, 다크 또는 시스템 테마를 선택합니다.', accentColor: '강조색', accentColorDescription: '주요 작업과 상태에 사용됩니다.', setAccentColor: '강조색 {color} 설정',
  ...
  'zh-TW': {
    ...
    themeDescription: '選擇淺色、純白、深色或跟隨系統。', accentColor: '強調色', accentColorDescription: '用於主要操作與狀態提示。', setAccentColor: '設定強調色 {color}',
