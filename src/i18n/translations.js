...
Object.assign(FEATURE_PAGE_TRANSLATIONS.zh.chatMessages, { replyPartiallyCompleted: '任务未完成。请查看下方的未完成原因、仍缺少项与下一步。' })
Object.assign(FEATURE_PAGE_TRANSLATIONS.en.chatMessages, { replyPartiallyCompleted: 'The task is incomplete. Review the reason, missing requirements, and next step below.' })
Object.assign(FEATURE_PAGE_TRANSLATIONS.ja.chatMessages, { replyPartiallyCompleted: 'タスクは未完了です。以下の理由、不足項目、次の手順を確認してください。' })
Object.assign(FEATURE_PAGE_TRANSLATIONS.ko.chatMessages, { replyPartiallyCompleted: '작업이 완료되지 않았습니다. 아래의 이유, 누락 항목, 다음 단계를 확인하세요.' })
Object.assign(FEATURE_PAGE_TRANSLATIONS['zh-TW'].chatMessages, { replyPartiallyCompleted: '任務尚未完成。請查看下方的未完成原因、仍缺少項目與下一步。' })
