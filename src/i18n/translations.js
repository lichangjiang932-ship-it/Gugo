...
const CHAT_SURFACE_TRANSLATIONS = {
  zh: {
    ...
    chatComposer: { allSkills: '全部技能', dropFiles: '松开以上传文件', fullDisk: '全盘', viewImage: '点击查看大图', removeAttachment: '移除附件', clearAttachments: '清空附件', placeholder: '输入指令，或 / 调用技能…', inputHistoryHint: '↑/↓ 查看历史输入 · Enter 发送 · Shift+Enter 换行', attachment: '附件', context: '上下文 · {count}', stop: '停止', send: '发送', steer: '追加指令' },
  ...
  ja: {
    ...
    chatComposer: { allSkills: 'すべてのスキル', dropFiles: 'ドロップしてアップロード', fullDisk: '全ファイル', viewImage: '画像を拡大表示', removeAttachment: '添付を削除', clearAttachments: '添付をすべて削除', placeholder: '指示を入力、または / でスキルを呼び出す…', inputHistoryHint: '↑/↓ 入力履歴を表示 · Enter で送信 · Shift+Enter で改行', attachment: '添付', context: 'コンテキスト · {count}', stop: '停止', send: '送信', steer: '指示を追加' },
  ...
  ko: {
    ...
    chatComposer: { allSkills: '모든 스킬', dropFiles: '놓아서 업로드', fullDisk: '전체 파일', viewImage: '큰 이미지 보기', removeAttachment: '첨부 삭제', clearAttachments: '첨부 모두 지우기', placeholder: '지시를 입력하거나 / 로 스킬 호출…', inputHistoryHint: '↑/↓ 입력 기록 보기 · Enter 전송 · Shift+Enter 줄 바꿈', attachment: '첨부', context: '컨텍스트 · {count}', stop: '중지', send: '보내기', steer: '지시 추가' },
  ...
  'zh-TW': {
    ...
    chatComposer: { allSkills: '全部技能', dropFiles: '放開以上傳檔案', fullDisk: '全碟', viewImage: '點擊檢視大圖', removeAttachment: '移除附件', clearAttachments: '清空附件', placeholder: '輸入指令，或用 / 呼叫技能…', inputHistoryHint: '↑/↓ 檢視歷史輸入 · Enter 傳送 · Shift+Enter 換行', attachment: '附件', context: '上下文 · {count}', stop: '停止', send: '傳送', steer: '追加指令' },
