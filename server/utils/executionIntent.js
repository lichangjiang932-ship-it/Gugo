...
const ANSWER_ONLY_LEAD = /^\s*(?:(?:\u8bf7)?(?:\u89e3\u91ca|\u8bf4\u660e|\u4ecb\u7ecd|\u544a\u8bc9\u6211|\u6bd4\u8f83)|(?:\u4ec0\u4e48\u662f|\u4e3a\u4ec0\u4e48|\u4e3a\u4f55|\u5982\u4f55|\u600e\u4e48|\u80fd\u5426|\u662f\u5426)|(?:what|why|how|explain|describe|compare|tell\s+me|can\s+you|could\s+you)\b)/i
...
const DELEGATED_EXECUTION_INTENT = /^(?:please\s+)?(?:handle|resolve|finish|complete|take\s+care\s+of|sort\s+out)\b|(?:\u4f60\u6765|\u4ea4\u7ed9\u4f60|\u7531\u4f60|\u9ebb\u70e6\u4f60|\u52b3\u70e6\u4f60|\u8bf7\u4f60).{0,80}(?:\u5904\u7406\u597d|\u6539\u597d|\u5b8c\u5584|\u4f18\u5316|\u4fee\u590d|\u4fee\u6539|\u5b9e\u73b0|\u8865\u5168|\u89e3\u51b3|\u641e\u5b9a|\u8c03\u6574|\u66f4\u65b0|\u91cd\u6784|\u521b\u5efa|\u751f\u6210|\u6267\u884c)/i
...
export function hasMutationExecutionIntent(text = '') {
  ...
  return MUTATION_EXECUTION_INTENT.test(prompt) || EXTERNAL_MUTATION_INTENT.test(prompt)
}
