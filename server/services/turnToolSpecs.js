...
const LOCAL_TASK_TOOL_NAMES = new Set([
  ...
  'create_pptx', 'create_docx', 'create_xlsx', 'create_pdf', 'create_html_app',
...
const ARTIFACT_KIND_TOOLS = {
  ...
  pdf: new Set(['create_pdf', 'pdf_info', 'pdf_text', 'pdf_transform', 'image_info', 'image_transform']),
  image: new Set(['generate_image', 'image_info', 'image_transform']),
