...
```json
{
  ...
  "files": [
    ...
    { "path": "server/services/TurnEngine.js", "ceiling": 2086, "group": "turn-agent-orchestration" },
    ...
    { "path": "server/services/userDataGovernanceService.js", "ceiling": 2152, "group": "artifact-delivery" },
