  ...
  theme: {
    extend: {
      colors: {
        ...
        'accent-contrast': 'rgb(var(--color-accent-contrast-rgb) / <alpha-value>)',
        'accent-ink': 'rgb(var(--color-accent-ink-rgb) / <alpha-value>)',
        'accent-soft': 'rgb(var(--color-accent-rgb) / 0.18)',
        'accent-line': 'rgb(var(--color-accent-rgb) / 0.55)',
        'accent-glow': 'rgb(var(--color-accent-rgb) / 0.10)',
        danger: 'rgb(var(--color-danger-rgb) / <alpha-value>)',
        warning: 'rgb(var(--color-warning-rgb) / <alpha-value>)',
        running: 'rgb(var(--color-running-rgb) / <alpha-value>)',
        success: 'rgb(var(--color-success-rgb) / <alpha-value>)',
        focus: 'rgb(var(--color-focus-rgb) / <alpha-value>)',
        // Compatibility aliases while non-class authored/export code is migrated.
